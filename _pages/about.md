...
2. **On the Perception Bottleneck of VLMs for Chart Understanding** (2025, arXiv)
   Junteng Liu, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. Code available on GitHub (Vision4Chart).

3. **On the Universal Truthfulness Hyperplane Inside LLMs** (EMNLP 2024)
   Junteng Liu, Shiqi Chen, Yu Cheng, Junxian He. Code available on GitHub (Universal_Truthfulness_Hyperplane).
...
Skills
======
My skills and research areas include:
